...
The R package and Shiny app implements count models to aid in estimating
Moose populations and composition. Analyses are based on surveyed cells,
residuals, point predictions, and prediction uncertainty help analysts
to adaptively survey sampling units. As a result of adaptive sampling,
models and estimates become more accurate. This improvement enables
better management of moose populations.

*The development of the R package and the Shiny app was funded by the
Government of Yukon.*
...
Define surveyed units and take a subset as needed (this also sets total
cows value):
...
Start univariate and multivariate exploration to see what drives the
...
Continuing with the Mayo data. Checks comp data (sum of classes should
equal total):
...
including total Moose and composition, using an interactive Shiny
application:
