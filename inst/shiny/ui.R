    ...
    column(width = 4,
           shinydashboard::box(width = 12,
               ...
               radioButtons("total_model_dist", "Distribution",
                            choices = c("P", "NB", "ZIP", "ZINB", "HP", "HNB"),
                            selected = "NB",
                            inline = TRUE),
               radioButtons("total_model_xv", NULL,
                            c("No Chi2" = FALSE, "Use blended Chi2" = TRUE),
                            inline = TRUE),
              #  radioButtons("total_model_weighted", NULL,
              #               c("Non weighted" = FALSE, "Weighted" = TRUE),
              #               inline = TRUE),
              #  radioButtons("total_model_robust", NULL,
              #               c("Ordinary ZI regression" = FALSE, "Robust ZI regression" = TRUE),
              #               inline = TRUE),
